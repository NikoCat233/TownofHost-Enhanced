    ...
    public static async void RpcVersionCheck()
    {
        try
        {
            ...
            if (Main.playerVersion.ContainsKey(hostId) || !Main.VersionCheat.Value)
            {
                ...
                writer.Write(cheating ? Main.playerVersion[hostId].version.ToString() : Main.FakeVersion.ToString());
            ...
            Main.playerVersion[PlayerControl.LocalPlayer.GetClientId()] = new PlayerVersion(Main.FakeVersion, Main.FakeGitInfo, Main.ForkId);
        }
        catch
        {
